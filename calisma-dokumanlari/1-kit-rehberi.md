# Kit Rehberi — `proje-kiti` ne yapıyor, nasıl kullanılır

> **Bu belge Barış'ın okuması için yazıldı.**
> ⛔ Ajan bunu okumaz; ajanın uyacağı kurallar `skills/yeni-proje/dosyalar/docs/standards/`
> altındadır. Burada kural yok, **anlatım** var.

**Kit sürümü:** 1.84.0 · **Son güncelleme:** 2026-09-06

Bu dosya üç ayrı belgenin birleşimidir: kitin ne yaptığı (referans), her terimin
açıklandığı rehber, ve *"kit nerede durur, projeye ne zaman gelir"* bölümü.
Üçü de aynı soruyu farklı açılardan cevapladığı için tek dosyada toplandı.
...
## Ek — Kit nerede durur, projeye ne zaman gelir
