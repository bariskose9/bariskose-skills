...
Seviyesi sabit değil, büyüyor: `docs/kullanici/calisilacak-konular.md` içindeki
...
| 4 | `/clear`, sonraki oturuma `docs/project/yeni-oturuma-verilecek-sonraki-adim-promptu.md` ile devret | Ajan |
