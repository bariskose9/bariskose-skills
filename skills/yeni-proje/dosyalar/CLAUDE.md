...
sana sorarak doldurur; elle kuruyorsan sen doldur. **Boş bırakılmaz** — ajanın
projeyi tanıdığı tek yer burasıdır.
...
PostgreSQL + Zod · Vercel + Neon + GitHub Actions · mobil varsa Expo (aynı REST API).
Sürümler `docs/standards/00-stack.md` içinde ve **fiilen kurulanla eşitlenir**.
